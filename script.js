...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    ...
    // Make sure outputs are hidden on load
    ...
    snapshotForm.addEventListener("submit", (e) => {
      ...
      if (!story) {
        ...
        if (snapshotOutput) snapshotOutput.classList.add("hidden");
        snapshotText.innerHTML = "";
        if (snapshotLetters) snapshotLetters.innerHTML = "";
        return;
      }

      // Show paywall step (honor system for payment)
      snapshotStatus.textContent = "";
    ...
    if (snapshotPaidBtn) {
      snapshotPaidBtn.addEventListener("click", () => {
        ...
        setTimeout(() => {
          ...
          if (snapshotOutput) snapshotOutput.classList.remove("hidden");
        }, 1200);
      });
    }
  }
...
// Build dispute letter drafts (you can decide later how much of this is for members only)
function buildDisputeLettersFromStory(story) {
  const safeStory = escapeHtml(story);

  return `
    <div class="snapshot-letter">
      <h5>Sample Dispute Letter to TransUnion</h5>
      <pre style="white-space:pre-wrap;font-size:0.9rem;border:1px solid #e5e7eb;border-radius:0.6rem;padding:0.6rem;background:#f9fafb;">
[Your Name]
[Your Address]
[City, State ZIP]
...
I am writing to dispute certain information on my TransUnion credit report.
This letter is based on my current understanding of my credit situation:

${safeStory}

Under the Fair Credit Reporting Act (FCRA), I am requesting that you
investigate any items that are inaccurate, incomplete, outdated, or
cannot be verified, and either correct them or remove them.

Please send me an updated copy of my report when your investigation is
complete.
...
[Your Name]
    ...
    <div class="snapshot-letter" style="margin-top:0.9rem;">
      <h5>Sample Dispute Letter to Experian</h5>
      <pre style="white-space:pre-wrap;font-size:0.9rem;border:1px solid #e5e7eb;border-radius:0.6rem;padding:0.6rem;background:#f9fafb;">
[Your Name]
[Your Address]
[City, State ZIP]
...
I am writing to dispute certain information on my Experian credit report.
This letter is based on my current understanding of my credit situation:
...
[Your Name]
    ...
    <div class="snapshot-letter" style="margin-top:0.9rem;">
      <h5>Sample Dispute Letter to Equifax</h5>
      <pre style="white-space:pre-wrap;font-size:0.9rem;border:1px solid #e5e7eb;border-radius:0.6rem;padding:0.6rem;background:#f9fafb;">
[Your Name]
[Your Address]
[City, State ZIP]
...
I am writing to dispute certain information on my Equifax credit report.
This letter is based on my current understanding of my credit situation:
